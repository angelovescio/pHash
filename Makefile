...
am__tagged_files = $(HEADERS) $(SOURCES) $(TAGS_FILES) \
	$(LISP)config.h.in pHash-config.h.in
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	$(srcdir)/pHash-config.h.in $(srcdir)/pHash.pc.in AUTHORS \
...
CPP = gcc -E
CPPFLAGS = -pthread -I/usr/local/include -I/usr/include/ffmpeg -Dcimg_use_png -Dcimg_use_jpeg -Dcimg_use_fftw3
CXX = g++
CXXCPP = g++ -E
...
LIBOBJS = 
LIBS = -lmpg123 -lsamplerate -lsndfile -lswscale -lavformat -lavutil -lavcodec   -lpng -ljpeg -lfftw3
...
STRIP = strip
VERSION = 0.9.6
abs_builddir = /home/vesh/a/multimedia/pHash
abs_srcdir = /home/vesh/a/multimedia/pHash
abs_top_builddir = /home/vesh/a/multimedia/pHash
abs_top_srcdir = /home/vesh/a/multimedia/pHash
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/vesh/a/multimedia/pHash/install-sh
